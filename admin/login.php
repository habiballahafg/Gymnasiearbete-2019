        ...
        <div class="auth-box bg-dark border-top border-secondary">
            <div id="loginform">
                <div class="text-center p-t-20 p-b-20">
                   <h3><a href="../index.php">GyAr v1.0</a> </h3>
                </div>
                <!-- Form -->
                        ...
                        <div class="col-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" placeholder="E-mail"
                                    value="<?php echo $email ?>"  name="email" aria-label="Username" aria-describedby="basic-addon1" required="">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                ...
                                <input type="password" class="form-control form-control-lg" placeholder="Password"
                                    value="<?php echo $password ?>"  name="password" aria-label="Password" aria-describedby="basic-addon1" required="">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <div class="p-t-20">
                                    ...
                                    <input type="submit" class="btn btn-success float-right" name="submit">Login</input>
                                </div>
                            </div>
                        </div>
                    </div>
